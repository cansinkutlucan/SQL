...
-- Bunu except ile yaptık. Bunu pivot table başka bir çıktıya bakalım. O 5 tane şart gösterdiğimiz de geldi(Mesela 74.satır)
-- .. burada  product_id ye göre bir nevi indexleme yaparak hangi product id den ne kadar var bunu görüyoruz
...
-- Bu çıktıya göre 
-- product_id 4 , 2018 de 5 tane mi?
select DISTINCT A.product_id,item_id, YEAR(order_date)   from sale.order_item A , sale.orders B
where A.order_id = B.order_id and YEAR(order_date)= '2018'
...
--- Başka bir alternatif yok ama olsaydı else 'other' yazarak diğerlerine "other" yazdırabiliyoruz
"""
###############
"""
