...
# Advantages of Views: Performance(uUzun sorguyu view olarak kaydedip kullanma), Security, Storage, Simplicity
"""
...
#########################
# 2.Grouping Sets
# Raporlama yaparken tüm gruplama sonuçlarının tek bir sot
"""
...
-- GROUPING SETS ile hemen hemen(50 rows biri, diğeri 51-NULL toplam eklenmil) aynı çıktı altta
...
group by
	grouping sets (
				...
				(category_id,brand_id,model_year) -- 3. group
	)
